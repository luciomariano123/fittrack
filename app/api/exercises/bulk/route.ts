...
const DEFAULT_EXERCISES = [
  ...
  { dayOfWeek: "Martes", name: "Tríceps barra", muscleGroup: "Tríceps", sets: 3, reps: "12", order: 5 },
  ...
  // MIÉRCOLES — Piernas + Glúteos + Core + Cardio (sin Russian twists)
  ...
  { dayOfWeek: "Miércoles", name: "Caminata en cinta inclinada (8-12%)", muscleGroup: "Cardio", sets: 1, reps: "20 min", order: 7 },

  // JUEVES — Hombros + Espalda + Bíceps + Cardio
  ...
  // VIERNES — Piernas + Espalda + Bíceps + Cardio (sin Sentadilla Smith)
  ...
  { dayOfWeek: "Viernes", name: "Jalón al pecho agarre ancho", muscleGroup: "Espalda", sets: 3, reps: "12", order: 4 },
  ...
  { dayOfWeek: "Viernes", name: "Cardio: correr ritmo medio", muscleGroup: "Cardio", sets: 1, reps: "25-30 min", order: 7 },

  // SÁBADO — Solo cardio
  { dayOfWeek: "Sábado", name: "Cardio zona 2: correr, bici o cinta conversacional", muscleGroup: "Cardio", sets: 1, reps: "40-45 min", order: 1 },
];
